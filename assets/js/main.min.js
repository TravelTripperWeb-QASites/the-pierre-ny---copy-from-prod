...
}],Mg=/(\s+|^)default(\s+|$)/,Te=function(){return{restrict:"A",controller:["$scope","$attrs",function(a,b){var d=this;this.$options=pa(a.$eval(b.ngModelOptions));A(this.$options.updateOn)?(this.$options.updateOnDefault=!1,this.$options.updateOn=W(this.$options.updateOn.replace(Mg,function(){d.$options.updateOnDefault=!0;return" "}))):this.$options.updateOnDefault=!0}]}},Fe=Na({terminal:!0,priority:1e3}),Ng=O("ngOptions"),Og=/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,Ne=["$compile","$parse",function(a,b){function d(a,c,d){function e(a,b,c,d,f){this.selectValue=a;this.viewValue=b;this.label=c;this.group=d;this.disabled=f}function l(a){var b;if(!p&&za(a))b=a;else{b=[];for(var c in a)a.hasOwnProperty(c)&&"$"!==c.charAt(0)&&b.push(c)}return b}var m=a.match(Og);if(!m)throw Ng("iexp",a,wa(c));var n=m[5]||m[7],p=m[6];a=/ as /.test(m[0])&&m[1];var q=m[9];c=b(m[2]?m[1]:n);var s=a&&b(a)||c,x=q&&b(q),r=q?function(a,b){return x(d,b)}:function(a){return Ha(a)},w=function(a,b){return r(a,y(a,b))},v=b(m[2]||m[1]),u=b(m[3]||""),t=b(m[4]||""),G=b(m[8]),C={},y=p?function(a,b){C[p]=b;C[n]=a;return C}:function(a){C[n]=a;return C};return{trackBy:q,getTrackByValue:w,getWatchables:b(G,function(a){var b=[];a=a||[];for(var c=l(a),e=c.length,f=0;f<e;f++){var g=a===c?f:c[f],k=a[g],g=y(k,g),k=r(k,g);b.push(k);if(m[2]||m[1])k=v(d,g),b.push(k);m[4]&&(g=t(d,g),b.push(g))}return b}),getOptions:function(){for(var a=[],b={},c=G(d)||[],f=l(c),g=f.length,m=0;m<g;m++){var n=c===f?m:f[m],p=y(c[n],n),x=s(d,p),n=r(x,p),C=v(d,p),A=u(d,p),p=t(d,p),x=new e(n,x,C,A,p);a.push(x);b[n]=x}return{items:a,selectValueMap:b,getOptionFromViewValue:function(a){return b[w(a)]},getViewValueFromOption:function(a){return q?ea.copy(a.viewValue):a.viewValue}}}}}var c=P.createElement("option"),e=P.createElement("optgroup");return{restrict:"A",terminal:!0,require:["select","ngModel"],link:{pre:function(a,b,c,d){d[0].registerOption=E},post:function(b,g,h,k){function l(a,b){a.element=b;b.disabled=a.disabled;a.label!==b.label&&(b.label=a.label,b.textContent=a.label);a.value!==b.value&&(b.value=a.selectValue)}function m(a,b,c,d){b&&N(b.nodeName)===c?c=b:(c=d.cloneNode(!1),b?a.insertBefore(c,b):a.appendChild(c));return c}function n(a){for(var b;a;)b=a.nextSibling,Yb(a),a=b}function p(a){var b=w&&w[0],c=G&&G[0];if(b||c)for(;a&&(a===b||a===c||8===a.nodeType||"option"===oa(a)&&""===a.value);)a=a.nextSibling;return a}function s(){var a=C&&u.readValue();C=z.getOptions();var b={},d=g[0].firstChild;t&&g.prepend(w);d=p(d);C.items.forEach(function(a){var f,h;A(a.group)?(f=b[a.group],f||(f=m(g[0],d,"optgroup",e),d=f.nextSibling,f.label=a.group,f=b[a.group]={groupElement:f,currentOptionElement:f.firstChild}),h=m(f.groupElement,f.currentOptionElement,"option",c),l(a,h),f.currentOptionElement=h.nextSibling):(h=m(g[0],d,"option",c),l(a,h),d=h.nextSibling)});Object.keys(b).forEach(function(a){n(b[a].currentOptionElement)});n(d);x.$render();if(!x.$isEmpty(a)){var f=u.readValue();(z.trackBy||r?na(a,f):a===f)||(x.$setViewValue(f),x.$render())}}var u=k[0],x=k[1],r=h.multiple,w;k=0;for(var v=g.children(),y=v.length;k<y;k++)if(""===v[k].value){w=v.eq(k);break}var t=!!w,G=H(c.cloneNode(!1));G.val("?");var C,z=d(h.ngOptions,g,b);r?(x.$isEmpty=function(a){return!a||0===a.length},u.writeValue=function(a){C.items.forEach(function(a){a.element.selected=!1});a&&a.forEach(function(a){(a=C.getOptionFromViewValue(a))&&!a.disabled&&(a.element.selected=!0)})},u.readValue=function(){var a=g.val()||[],b=[];q(a,function(a){(a=C.selectValueMap[a])&&!a.disabled&&b.push(C.getViewValueFromOption(a))});return b},z.trackBy&&b.$watchCollection(function(){if(M(x.$viewValue))return x.$viewValue.map(function(a){return z.getTrackByValue(a)})},function(){x.$render()})):(u.writeValue=function(a){var b=C.getOptionFromViewValue(a);b&&!b.disabled?(g[0].value!==b.selectValue&&(G.remove(),t||w.remove(),g[0].value=b.selectValue,b.element.selected=!0),b.element.setAttribute("selected","selected")):null===a||t?(G.remove(),t||g.prepend(w),g.val(""),w.prop("selected",!0),w.attr("selected",!0)):(t||w.remove(),g.prepend(G),g.val("?"),G.prop("selected",!0),G.attr("selected",!0))},u.readValue=function(){var a=C.selectValueMap[g.val()];return a&&!a.disabled?(t||w.remove(),G.remove(),C.getViewValueFromOption(a)):null},z.trackBy&&b.$watch(function(){return z.getTrackByValue(x.$viewValue)},function(){x.$render()}));t?(w.remove(),a(w)(b),w.removeClass("ng-scope")):w=H(c.cloneNode(!1));s();b.$watchCollection(z.getWatchables,s)}}}}],Ge=["$locale","$interpolate","$log",function(a,b,d){var c=/{}/g,e=/^when(Minus)?(.+)$/;return{link:function(f,g,h){function k(a){g.text(a||"")}var l=h.count,m=h.$attr.when&&g.attr(h.$attr.when),n=h.offset||0,p=f.$eval(m)||{},s={},u=b.startSymbol(),x=b.endSymbol(),r=u+l+"-"+n+x,w=ea.noop,v;q(h,function(a,b){var c=e.exec(b);c&&(c=(c[1]?"-":"")+N(c[2]),p[c]=g.attr(h.$attr[b]))});q(p,function(a,d){s[d]=b(a.replace(c,r))});f.$watch(l,function(b){var c=parseFloat(b),e=isNaN(c);e||c in p||(c=a.pluralCat(c-n));c===v||e&&R(v)&&isNaN(v)||(w(),e=s[c],z(e)?(null!=b&&d.debug("ngPluralize: no rule defined for '"+c+"' in "+m),w=E,k()):w=f.$watch(e,k),v=c)})}}}],He=["$parse","$animate","$compile",function(a,b,d){var c=O("ngRepeat"),e=function(a,b,c,d,e,m,n){a[c]=d;e&&(a[e]=m);a.$index=b;a.$first=0===b;a.$last=b===n-1;a.$middle=!(a.$first||a.$last);a.$odd=!(a.$even=0===(b&1))};return{restrict:"A",multiElement:!0,transclude:"element",priority:1e3,terminal:!0,$$tlb:!0,compile:function(f,g){var h=g.ngRepeat,k=d.$$createComment("end ngRepeat",h),l=h.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);if(!l)throw c("iexp",h);var m=l[1],n=l[2],p=l[3],s=l[4],l=m.match(/^(?:(\s*[\$\w]+)|\(\s*([\$\w]+)\s*,\s*([\$\w]+)\s*\))$/);if(!l)throw c("iidexp",m);var y=l[3]||l[1],x=l[2];if(p&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(p)||/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(p)))throw c("badident",p);var r,w,v,z,t={$id:Ha};s?r=a(s):(v=function(a,b){return Ha(b)},z=function(a){return a});return function(a,d,f,g,l){r&&(w=function(b,c,d){x&&(t[x]=b);t[y]=c;t.$index=d;return r(a,t)});var m=V();a.$watchCollection(n,function(f){var g,n,r=d[0],s,t=V(),A,E,H,D,I,F,J;p&&(a[p]=f);if(za(f))I=f,n=w||v;else for(J in n=w||z,I=[],f)va.call(f,J)&&"$"!==J.charAt(0)&&I.push(J);A=I.length;J=Array(A);for(g=0;g<A;g++)if(E=f===I?g:I[g],H=f[E],D=n(E,H,g),m[D])F=m[D],delete m[D],t[D]=F,J[g]=F;else{if(t[D])throw q(J,function(a){a&&a.scope&&(m[a.id]=a)}),c("dupes",h,D,H);J[g]={id:D,scope:u,clone:u};t[D]=!0}for(s in m){F=m[s];D=ub(F.clone);b.leave(D);if(D[0].parentNode)for(g=0,n=D.length;g<n;g++)D[g].$$NG_REMOVED=!0;F.scope.$destroy()}for(g=0;g<A;g++)if(E=f===I?g:I[g],H=f[E],F=J[g],F.scope){s=r;do{s=s.nextSibling}while(s&&s.$$NG_REMOVED);F.clone[0]!=s&&b.move(ub(F.clone),null,r);r=F.clone[F.clone.length-1];e(F.scope,g,y,H,x,E,A)}else l(function(a,c){F.scope=c;var d=k.cloneNode(!1);a[a.length++]=d;b.enter(a,null,r);r=d;F.clone=a;t[F.id]=F;e(F.scope,g,y,H,x,E,A)});m=t})}}}}],Ie=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(b,d,c){b.$watch(c.ngShow,function(b){a[b?"removeClass":"addClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],Be=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(b,d,c){b.$watch(c.ngHide,function(b){a[b?"addClass":"removeClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],Je=Na(function(a,b,d){a.$watch(d.ngStyle,function(a,d){d&&a!==d&&q(d,function(a,c){b.css(c,"")});a&&b.css(a)},!0)}),Ke=["$animate","$compile",function(a,b){return{require:"ngSwitch",controller:["$scope",function(){this.cases={}}],link:function(d,c,e,f){var g=[],h=[],k=[],l=[],m=function(a,b){return function(){a.splice(b,1)}};d.$watch(e.ngSwitch||e.on,function(c){var d,e;d=0;for(e=k.length;d<e;++d)a.cancel(k[d]);d=k.length=0;for(e=l.length;d<e;++d){var s=ub(h[d].clone);l[d].$destroy();(k[d]=a.leave(s)).then(m(k,d))}h.length=0;l.length=0;(g=f.cases["!"+c]||f.cases["?"])&&q(g,function(c){c.transclude(function(d,e){l.push(e);var f=c.element;d[d.length++]=b.$$createComment("end ngSwitchWhen");h.push({clone:d});a.enter(d,f.parent(),f)})})})}}}],Le=Na({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,b,d,c,e){c.cases["!"+d.ngSwitchWhen]=c.cases["!"+d.ngSwitchWhen]||[];c.cases["!"+d.ngSwitchWhen].push({transclude:e,element:b})}}),Me=Na({transclude:"element",priority:1200,require:"^ngSwitch",multiElement:!0,link:function(a,b,d,c,e){c.cases["?"]=c.cases["?"]||[];c.cases["?"].push({transclude:e,element:b})}}),Pg=O("ngTransclude"),Oe=Na({restrict:"EAC",link:function(a,b,d,c,e){d.ngTransclude===d.$attr.ngTransclude&&(d.ngTransclude="");if(!e)throw Pg("orphan",wa(b));e(function(a){a.length&&(b.empty(),b.append(a))},null,d.ngTransclude||d.ngTranscludeSlot)}}),oe=["$templateCache",function(a){return{restrict:"E",terminal:!0,compile:function(b,d){"text/ng-template"==d.type&&a.put(d.id,b[0].text)}}}],Qg={$setViewValue:E,$render:E},Rg=["$element","$scope",function(a,b){var d=this,c=new Ua;d.ngModelCtrl=Qg;d.unknownOption=H(P.createElement("option"));d.renderUnknownOption=function(b){b="? "+Ha(b)+" ?";d.unknownOption.val(b);a.prepend(d.unknownOption);a.val(b)};b.$on("$destroy",function(){d.renderUnknownOption=E});d.removeUnknownOption=function(){d.unknownOption.parent()&&d.unknownOption.remove()};d.readValue=function(){d.removeUnknownOption();return a.val()};d.writeValue=function(b){d.hasOption(b)?(d.removeUnknownOption(),a.val(b),""===b&&d.emptyOption.prop("selected",!0)):null==b&&d.emptyOption?(d.removeUnknownOption(),a.val("")):d.renderUnknownOption(b)};d.addOption=function(a,b){if(8!==b[0].nodeType){Ta(a,'"option value"');""===a&&(d.emptyOption=b);var g=c.get(a)||0;c.put(a,g+1);d.ngModelCtrl.$render();b[0].hasAttribute("selected")&&(b[0].selected=!0)}};d.removeOption=function(a){var b=c.get(a);b&&(1===b?(c.remove(a),""===a&&(d.emptyOption=u)):c.put(a,b-1))};d.hasOption=function(a){return!!c.get(a)};d.registerOption=function(a,b,c,h,k){if(h){var l;c.$observe("value",function(a){A(l)&&d.removeOption(l);l=a;d.addOption(a,b)})}else k?a.$watch(k,function(a,e){c.$set("value",a);e!==a&&d.removeOption(e);d.addOption(a,b)}):d.addOption(c.value,b);b.on("$destroy",function(){d.removeOption(c.value);d.ngModelCtrl.$render()})}}],pe=function(){return{restrict:"E",require:["select","?ngModel"],controller:Rg,priority:1,link:{pre:function(a,b,d,c){var e=c[1];if(e){var f=c[0];f.ngModelCtrl=e;b.on("change",function(){a.$apply(function(){e.$setViewValue(f.readValue())})});if(d.multiple){f.readValue=function(){var a=[];q(b.find("option"),function(b){b.selected&&a.push(b.value)});return a};f.writeValue=function(a){var c=new Ua(a);q(b.find("option"),function(a){a.selected=A(c.get(a.value))})};var g,h=NaN;a.$watch(function(){h!==e.$viewValue||na(g,e.$viewValue)||(g=ia(e.$viewValue),e.$render());h=e.$viewValue});e.$isEmpty=function(a){return!a||0===a.length}}}},post:function(a,b,d,c){var e=c[1];if(e){var f=c[0];e.$render=function(){f.writeValue(e.$viewValue)}}}}}},re=["$interpolate",function(a){return{restrict:"E",priority:100,compile:function(b,d){if(A(d.value))var c=a(d.value,!0);else{var e=a(b.text(),!0);e||d.$set("value",b.text())}return function(a,b,d){var k=b.parent();(k=k.data("$selectController")||k.parent().data("$selectController"))&&k.registerOption(a,b,d,c,e)}}}}],qe=da({restrict:"E",terminal:!1}),Fc=function(){return{restrict:"A",require:"?ngModel",link:function(a,b,d,c){c&&(d.required=!0,c.$validators.required=function(a,b){return!d.required||!c.$isEmpty(b)},d.$observe("required",function(){c.$validate()}))}}},Ec=function(){return{restrict:"A",require:"?ngModel",link:function(a,b,d,c){if(c){var e,f=d.ngPattern||d.pattern;d.$observe("pattern",function(a){y(a)&&0<a.length&&(a=new RegExp("^"+a+"$"));if(a&&!a.test)throw O("ngPattern")("noregexp",f,a,wa(b));e=a||u;c.$validate()});c.$validators.pattern=function(a,b){return c.$isEmpty(b)||z(e)||e.test(b)}}}}},Hc=function(){return{restrict:"A",require:"?ngModel",link:function(a,b,d,c){if(c){var e=-1;d.$observe("maxlength",function(a){a=Y(a);e=isNaN(a)?-1:a;c.$validate()});c.$validators.maxlength=function(a,b){return 0>e||c.$isEmpty(b)||b.length<=e}}}}},Gc=function(){return{restrict:"A",require:"?ngModel",link:function(a,b,d,c){if(c){var e=0;d.$observe("minlength",function(a){e=Y(a)||0;c.$validate()});c.$validators.minlength=function(a,b){return c.$isEmpty(b)||b.length>=e}}}}};T.angular.bootstrap?T.console&&console.log("WARNING: Tried to load angular more than once."):(he(),je(ea),ea.module("ngLocale",[],["$provide",function(a){function b(a){a+="";var b=a.indexOf(".");return-1==b?0:a.length-b-1}a.value("$locale",{DATETIME_FORMATS:{AMPMS:["AM","PM"],DAY:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),ERANAMES:["Before Christ","Anno Domini"],ERAS:["BC","AD"],FIRSTDAYOFWEEK:6,MONTH:"January February March April May June July August September October November December".split(" "),SHORTDAY:"Sun Mon Tue Wed Thu Fri Sat".split(" "),SHORTMONTH:"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),STANDALONEMONTH:"January February March April May June July August September October November December".split(" "),WEEKENDRANGE:[5,6],fullDate:"EEEE, MMMM d, y",longDate:"MMMM d, y",medium:"MMM d, y h:mm:ss a",mediumDate:"MMM d, y",mediumTime:"h:mm:ss a",short:"M/d/yy h:mm a",shortDate:"M/d/yy",shortTime:"h:mm a"},NUMBER_FORMATS:{CURRENCY_SYM:"$",DECIMAL_SEP:".",GROUP_SEP:",",PATTERNS:[{gSize:3,lgSize:3,maxFrac:3,minFrac:0,minInt:1,negPre:"-",negSuf:"",posPre:"",posSuf:""},{gSize:3,lgSize:3,maxFrac:2,minFrac:2,minInt:1,negPre:"-¤",negSuf:"",posPre:"¤",posSuf:""}]},id:"en-us",localeID:"en_US",pluralCat:function(a,c){var e=a|0,f=c;u===f&&(f=Math.min(b(a),3));Math.pow(10,f);return 1==e&&0==f?"one":"other"}})}]),H(P).ready(function(){de(P,yc)}))})(window,document);!window.angular.$$csp().noInlineStyle&&window.angular.element(document.head).prepend('<style type="text/css">@charset "UTF-8";[ng\\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\\:form{display:block;}.ng-animate-shim{visibility:hidden;}.ng-anchor{position:absolute;}</style>');function Rt3Api(params){this.config=params;this.roomCache=null}Rt3Api.prototype.getHotelInfo=function(){var path="/hotels/details.json";var params={hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale};return query(path,params)};Rt3Api.prototype.getPortalInfo=function(){var path="/portals/"+this.config.portalId+".json";var params={locale:this.config.defaultLocale,currency:this.config.defaultCurrency};return query(path,params)};Rt3Api.prototype.getAllRooms=function(){var self=this;var path="/hotels/rooms.json";var params={rooms:1,hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale};var defer=$.Deferred();if(this.roomCache){defer.resolve(this.roomCache)}else{query(path,params).then(function(result){self.roomCache=result;defer.resolve(result)})}return defer};Rt3Api.prototype.availableRooms=function(searchParams){var path="/hotels/roomRateList.json";var defaultParams={hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale,currency:this.config.defaultCurrency};var params=$.extend(defaultParams,searchParams);return query(path,params)};Rt3Api.prototype.getAllAvailableRooms=function(searchParams){var path="/hotels/rooms.json";var newParams={};if(searchParams){newParams.arrival_date_0=searchParams.arrival_date;newParams.departure_date_0=searchParams.departure_date;newParams.adults_0=searchParams.adults;newParams.children_0=searchParams.children;newParams.rooms=1;delete searchParams.arrival_date;delete searchParams.departure_date;delete searchParams.adults;delete searchParams.children}else{var now=new Date;var day=("0"+now.getDate()).slice(-2);var month=("0"+(now.getMonth()+1)).slice(-2);var today=now.getFullYear()+"-"+month+"-"+day;var nextDay;nextDay=new Date(today);var tomarrow=new Date(nextDay.setDate(nextDay.getDate()+1));var depart=tomarrow.toISOString().slice(0,10);newParams.arrival_date_0=today;newParams.departure_date_0=depart;newParams.adults_0=2;newParams.children_0=0;newParams.rooms=1}var defaultParams={hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale,currency:this.config.defaultCurrency,ip_address:sessionStorage.ip_add};var params=$.extend(defaultParams,newParams,searchParams);return query(path,params)};Rt3Api.prototype.availableRoomsTonight=function(){var path="/hotels/roomRateList.json";var now=new Date;var day=("0"+now.getDate()).slice(-2);var month=("0"+(now.getMonth()+1)).slice(-2);var today=now.getFullYear()+"-"+month+"-"+day;var nextDay;nextDay=new Date(today);var tomarrow=new Date(nextDay.setDate(nextDay.getDate()+1));var depart=tomarrow.toISOString().slice(0,10);var defaultParams={hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale,currency:this.config.defaultCurrency,arrival_date:today,departure_date:depart,adults:2,children:0,rooms:1};return query(path,defaultParams)};Rt3Api.prototype.getAllSpecialRates=function(){var path="/hotels/special_rates.json";var params={hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale,currency:this.config.defaultCurrency};return query(path,params)};Rt3Api.prototype.getRoomInfo=function(searchParams){var path="/hotels/roomDetails.json";var defaultParams={hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale,currency:this.config.defaultCurrency};var params=$.extend(defaultParams,searchParams);return query(path,params)};Rt3Api.prototype.getRateShopping=function(searchParams){var path="/hotels/rateshopping.json";var defaultParams={hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale,currency:this.config.defaultCurrency,popular_only:false,num_rates_display:15,client_ip:sessionStorage.ip_add,lowest_rate:null,search_lowest:true};var params=$.extend(defaultParams,reformatParams(searchParams));function reformatParams(searchParams){var params=searchParams;params["adults[]"]=searchParams.adults||2;params["children[]"]=searchParams.children||0;params.rooms=searchParams.rooms||1;return params}return query(path,params)};Rt3Api.prototype.getBrgInfo=function(searchParams){var self=this;var defaultParams={hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale,currency:this.config.defaultCurrency};var params=$.extend(defaultParams,searchParams);var defered=$.Deferred();var roomInfo=this.getRoomInfo(params).then(function(response){var ratePlans=response.rate_plans;self.getAllRooms().then(function(rooms_response){if(ratePlans){var is_base_room_type=false;$.each(rooms_response.rooms,function(key,value){if(value.code==params.room_id&&value.is_base_room_type){is_base_room_type=true}});if(is_base_room_type){self.getRateShopping({arrival_date:searchParams.arrival_date,departure_date:searchParams.departure_date,adults:searchParams.adults,children:searchParams.children}).then(function(rsResponse){if(rsResponse.error_info.error_details.length){if(console&&console.error){}}if(rsResponse.show_brg){var response={discounted_rate:rsResponse.discounted_rate||rsResponse.original_rate,code:"BRG",rates:rsResponse.rates,avg_brg_discounted_price:rsResponse.discounted_rate,avg_brg_original_price:rsResponse.original_rate,show_brg:true,discount_threshold_exceeded:rsResponse.discount_threshold_exceeded,dpr_name:rsResponse.dpr_name};defered.resolve(response)}else{var response={discounted_rate:ratePlans[0].average_discounted_nightly_price||ratePlans[0].average_nightly_price,code:ratePlans[0].code,rates:[]};defered.resolve(response)}})}else{var response={discounted_rate:ratePlans[0].average_discounted_nightly_price||ratePlans[0].average_nightly_price,code:ratePlans[0].code,rates:[]};defered.resolve(response)}}else{var response={discounted_rate:null,code:null,rates:[]};defered.resolve(response)}})});return defered};Rt3Api.prototype.getOTARates=function(params){var searchParams,startDate,endDate,retResponse={},reztripRate,brg={},brgFound;var defered=$.Deferred();var now=new Date;var day=("0"+now.getDate()).slice(-2);var month=("0"+(now.getMonth()+1)).slice(-2);var startDate=now.getFullYear()+"-"+month+"-"+day;var nextDay;nextDay=new Date(startDate);var tomarrow=new Date(nextDay.setDate(nextDay.getDate()+1));var endDate=tomarrow.toISOString().slice(0,10);searchParams={arrival_date:startDate,departure_date:endDate};if(params){searchParams=$.extend(searchParams,params)}this.getRateShopping(searchParams).then(function(response){var errors=response.error_info;if(errors&&errors.error_details.length>0){defered.reject(errors)}else{if(response.show_brg){reztripRate="$"+Math.round(response.discounted_rate);response.rates.forEach(function(ota){brg[ota.provider]=ota.rate});brgFound=response.rates.length>0?true:false;retResponse={reztripRate:reztripRate,brg:brg,brgFound:brgFound};defered.resolve(retResponse)}else{retResponse={error_info:{error_details:[{error_type:"NOT_ALLOWED",error_messgae:"BRG rates are not allowed to display."}]}};defered.reject(retResponse)}}});return defered};Rt3Api.prototype.recentBookings=function(timeCutOffMinutes){var path="/ext/recentBookings";var params={propertyCode:this.config.hotelId,timeCutOffMinutes:timeCutOffMinutes};return query(path,params)};Rt3Api.prototype.rateCalendarForToday=function(searchParams){var path="/hotels/rate_calendar.json";var startDate=(new Date).toISOString().slice(0,10);var today=new Date(startDate);var endFullDate=new Date(today.setDate(today.getDate()+120));var endDate=endFullDate.toISOString().slice(0,10);var defaultParams={hotel_id:this.config.hotelId,portal_id:this.config.portalId,locale:this.config.defaultLocale,currency:this.config.defaultCurrency,start_date:startDate,end_date:endDate,adults:1,children:0,rooms:1,ip_address:sessionStorage.ip_add,lowest_rate:null};var params=$.extend(defaultParams,searchParams);return query(path,params)};function query(path,params){var rootPath="https://rt3api-prd.ttaws.com";return $.ajax({url:rootPath+path,method:"GET",data:params})}(function(){angular.module("rezTrip",[],function($interpolateProvider){$interpolateProvider.startSymbol("[[");$interpolateProvider.endSymbol("]]")}).value("rt3api",new Rt3Api({portalId:"thepierreny",hotelId:"NYCTP",defaultLocale:$("#siteLang").val()||"en",defaultCurrency:"USD"})).config(function($locationProvider){$locationProvider.html5Mode({enabled:true,requireBase:false,rewriteLinks:false})}).directive("onSearchChanged",function(rt3Search){return{scope:false,restrict:"A",link:function(scope,element,attrs){scope.$watch("search.params",function(params){if(params.arrival_date&&params.departure_date){scope.$eval(attrs.onSearchChanged)}},true);scope.$eval(attrs.onSearchChanged)}}}).controller("roomDetail",["$scope","rt3Search","rt3Browser","$timeout","$filter","$http",function($scope,rt3Search,rt3Browser,$timeout,$filter,$http){window.onhashchange=function(){window.location.reload()};$scope.reloadPage=function(){window.location.reload()};$timeout(function(){var roomsList=JSON.parse($("#roomList").val());var roomId=window.location.hash.substr(1).replace("%2F","");var roomSizeSqm;var roomSizeSqft;var address,coord,lat,long,shortDesc;for(var j=0;j<roomsList.length;j++){rName=$filter("formatNameForLink")(roomId);tmpName=$filter("formatNameForLink")(roomsList[j].name);if(rName==tmpName){if(roomsList[j].room_size_units=="sqft"){roomSizeSqm=roomsList[j].room_size/10.764;roomsList[j]["room_size_sqm"]=Math.round(roomSizeSqm)+" sq m";roomsList[j]["room_size_sqft"]=roomsList[j].room_size+" "+" sq ft"}else if(roomsList[j].room_size_units=="sqm"){roomSizeSqft=roomsList[j].room_size*10.764;roomsList[j]["room_size_sqft"]=Math.round(roomSizeSqft)+" sq ft";roomsList[j]["room_size_sqm"]=roomsList[j].room_size+" sq m"}$scope.selectedRoom=roomsList[j];if(j>0){$scope.prevRoomName=roomsList[j-1].name}if(j<roomsList.length-1){$scope.nextRoomName=roomsList[j+1].name}break}}$(".loading").css("display","none")},2800)}]).controller("offerDetail",["$scope","rt3Search","rt3Browser","$timeout","$filter",function($scope,rt3Search,rt3Browser,$timeout,$filter){window.onhashchange=function(){window.location.reload()};$scope.reloadPage=function(){$window.location.reload()};$timeout(function(){var oList=JSON.parse($("#offerList").val());var oName=window.location.hash.substr(1);var tmpName;for(var j=0;j<oList.length;j++){oName=$filter("formatNameForLink")(oName);tmpName=$filter("formatNameForLink")(oList[j].rate_plan_name);if(tmpName==oName){if(j>0){$scope.prevOfferName=oList[j-1].rate_plan_name}if(j<oList.length-1){$scope.nextOfferName=oList[j+1].rate_plan_name}break}}},2800)}]).controller("bookingWidget",["$scope","rt3Search","rt3Browser",function($scope,rt3Search,rt3Browser){var self=this;this.arrivalOptions={minDate:0};this.departureOptions={minDate:1};this.chachgeMinDate=function(target){var today=(new Date).getDate();var arr=new Date($scope.search.params.arrival_date).getDate();var arrm=new Date($scope.search.params.arrival_date).getMonth();var gettonightstatus=rt3Browser.roomsTonight.length;if(gettonightstatus==0){$(".price").hide()}if(target=="departure"){var dept=new Date($scope.search.params.arrival_date);var theDay=new Date(dept.setDate(dept.getDate()+1));self.departureOptions.minDate=theDay.getDate()-today+1;var newDay=theDay.toISOString().slice(0,10);$scope.search.params.departure_date=newDay;rt3Browser.getdiff=false}if(target=="depart"){var date1=new Date($scope.search.params.arrival_date);var date2=new Date($scope.search.params.departure_date);var timeDiff=Math.abs(date2.getTime()-date1.getTime());var diffDays=Math.ceil(timeDiff/(1e3*3600*24));if(diffDays>=2){rt3Browser.getdiff=true}}}}])})();angular.module("rezTrip").service("rt3HotelInfo",["$rootScope","$q","rt3api",function($rootScope,$q,rt3api){var hotelInfo={loaded:false,galleryImg:[]};hotelInfo.ready=$q(function(resolve){rt3api.getHotelInfo().then(function(response){$rootScope.$apply(function(){angular.extend(hotelInfo,response);hotelInfo.loaded=true;hotelInfo.galleryImg=galleryArr(response.photos);resolve(hotelInfo)})})});function galleryArr(items){var arr=[];for(var i=0;i<items.length;i++){arr.push(items[i].thumb_yankee_medium)}return arr}return hotelInfo}]).service("rt3PortalInfo",["$rootScope","$q","rt3api",function($rootScope,$q,rt3api){var searchParams={loaded:false};searchParams.ready=$q(function(resolve){rt3api.getPortalInfo().then(function(response){$rootScope.$apply(function(){angular.extend(searchParams,response);searchParams.loaded=true;resolve(searchParams)})})});return searchParams}]).service("rt3Search",["rt3PortalInfo","rt3api","$rootScope",function(rt3PortalInfo,rt3api,$rootScope){function Search(){var self=this;this.loaded=false;this.constraints={};this.params={};this.today=today();prepareConstraintsAndParams(this);function paramsFn(){return self.params}}Search.prototype.getParams=function(){var self=this;return{arrival_date:self.params.arrival_date||today(),departure_date:self.params.departure_date||today(1),adults:self.constraints.default_number_of_adults_per_room||2,children:self.params.children||self.constraints.min_number_of_children_per_room||0,rooms:self.params.rooms||self.constraints.default_number_of_rooms||1}};return new Search;function prepareConstraintsAndParams(self){rt3PortalInfo.ready.then(function(response){angular.extend(self.constraints,extractsConstraints(response));angular.extend(self.params,extractsParams(response));self.loaded=true})}function extractsConstraints(params){return{min_length_of_stay:params.min_length_of_stay,max_length_of_stay:params.max_length_of_stay,numbers_of_rooms:params.numbers_of_rooms,default_number_of_rooms:params.default_number_of_rooms,min_number_of_adults_per_room:params.min_number_of_adults_per_room,max_number_of_adults_per_room:params.max_number_of_adults_per_room,default_number_of_adults_per_room:params.default_number_of_adults_per_room,min_number_of_children_per_room:params.min_number_of_children_per_room,max_number_of_children_per_room:params.max_number_of_children_per_room,min_number_of_guests_per_room:params.min_number_of_guests_per_room,max_number_of_guests_per_room:params.max_number_of_guests_per_room}}function extractsParams(params){function defaultSearchParams(params){return{arrival_date:today(),departure_date:today(1),portal_id:rt3api.config.portalId,hotel_id:rt3api.config.hotelId,locale:rt3api.config.defaultLocale,currency:rt3api.config.defaultCurrency,rooms:params.default_number_of_rooms,adults:params.default_number_of_adults_per_room,children:params.min_number_of_children_per_room}}return defaultSearchParams(params)}function today(minLos){var date=new Date;var n=minLos||0;return date.getFullYear()+"-"+("0"+(date.getMonth()+1)).slice(-2)+"-"+("0"+(date.getDate()+n)).slice(-2)}}]).service("rt3Browser",["$rootScope","$q","rt3api","rt3Search","$timeout",function($rootScope,$q,rt3api,rt3Search,$timeout){function Browser(){this.loaded=false;this.roomsTonight=[];this.rooms=[];this.toNigthsRate;this.errors=[];this.tonightErrors=[];this.searchParams={};this.getdiff=false}Browser.prototype.tonightRate=function(){var self=this;self.isRate=true;rt3api.getAllAvailableRooms().then(function(response){$rootScope.$applyAsync(function(){self.roomsv=response.rooms;self.tonightErrors=response.error_info.error_details;var roomCategories=response.rooms.map(function(obj){return obj.category});roomCategories=roomCategories.filter(function(v,i){return roomCategories.indexOf(v)==i});self.roomCategories=roomCategories;if(self.roomsv.length==0){self.isRate=false}else{var roomRate;var todayRate={};self.isRate=false;angular.forEach(self.roomsv,function(room,key){roomRate=room.min_discounted_average_price[0]||room.min_average_price[0];if(room.min_average_price[0]!=null&&!self.isRate){self.isRate=true;self.toNightsRate="$"+Math.round(roomRate)}if(roomRate==null){todayRate={todayRate:"Check Availability"}}else{todayRate={todayRate:"$ "+Math.round(roomRate)}}angular.extend(self.roomsv[key],todayRate)});self.roomsInSuites=self.roomsv.filter(function(v,i){return v.category.toLowerCase()=="grand suites"})}self.loaded=true;angular.extend(self,{otaRates:{brgFound:false}});$q.when(rt3api.getOTARates()).then(function(response){if(response.brgFound){if(Object.keys){var len,lastKey;while(Object.keys(response.brg).length>4){len=Object.keys(response.brg).length;lastKey=Object.keys(response.brg)[len-1];delete response.brg[lastKey]}}}angular.extend(self,{otaRates:response})},function(response){angular.extend(self,{otaRates:{brgFound:false}})})})})};Browser.prototype.search=function(params){var date=new Date;var self=this;this.loaded=false;this.searchParams=params||rt3Search.getParams();this.thisDate=date.getFullYear()+"-"+("0"+(date.getMonth()+1)).slice(-2)+"-"+("0"+date.getDate()).slice(-2);if(this.searchParams||this.storageContainer){rt3api.getAllAvailableRooms(this.searchParams||this.storageContainer).then(function(response){$rootScope.$apply(function(){self.rooms=response.rooms;if(self.rooms.length==0){self.getRate="Check Availability";$(".-count").css("font-size","23px");$(".-count").css("line-height","28px");$(".-count").css("text-align","center")}else{var showRate=self.rooms[0].min_discounted_average_price[0]||self.rooms[0].min_average_price[0];if(showRate==null){showRate="Check Availability";$(".-count").css("font-size","23px");$(".-count").css("line-height","28px");$(".-count").css("text-align","center")}else{$(".-count").css("font-size","36px");$(".-count").css("line-height","40px");$(".-count").css("text-align","left");showRate=Math.round(showRate)}self.getRate=showRate}
self.errors=response.error_info.error_details;self.loaded=true;self.searchParams=self.searchParams||self.storageContainer})})}else{rt3api.getAllRooms().then(function(response){$rootScope.$apply(function(){self.rooms=response.rooms;self.errors=response.error_info.error_details;self.loaded=true})})}};var browser=new Browser;browser.tonightRate();return browser}]).service("rt3Browser1",["$rootScope","$q","rt3api","rt3Search",function($rootScope,$q,rt3api,rt3Search){function Browser(){this.loaded=false;this.roomsTonight=[];this.rooms=[];this.toNigthsRate;this.errors=[];this.tonightErrors=[];this.searchParams={};this.allRoomCodes=[]}Browser.prototype.tonightavailRooms=function(selectedRoom){var self=this;var code=[];var categoryRoomsCode=[];var allRoomsCode=[];self.isRate=true;var selCatRooms=[];self.roomsCatWise={};self.chunkedCategories={};var selectedRoomId=typeof selectedRoom!=="undefined"&&selectedRoom!==null?selectedRoom:"";var dataRoomCategory=angular.element("[data-room-category]").data("room-category");var roomCategory=typeof dataRoomCategory!=="undefined"?dataRoomCategory:"ALL";var categories=[];rt3api.getAllRooms().then(function(result){$rootScope.$applyAsync(function(){var tmpCat;angular.forEach(result.rooms,function(value,key){allRoomsCode.push(value.code)});self.roomsv=result.rooms;self.roomsInSuites=result.rooms.filter(function(v,i){return v.category.toLowerCase()=="grand suites"});self.allRoomsCode=allRoomsCode})});rt3api.availableRoomsTonight().then(function(response){$rootScope.$apply(function(){self.roomsTonight=response.room_details_list;self.tonightErrors=response.error_info.error_details;if(self.roomsTonight.length==0){self.isRate=false}else{this.isRate=true;self.toNightsRate="$"+Math.round(self.roomsTonight[0].min_average_price)}var roomStatusResult=checkRoomStatus(response.room_details_list,self.roomsTonight.length,allRoomsCode,selectedRoomId);self.roomRates=roomStatusResult.tonightrate;self.selectedRoomRate=roomStatusResult.selectedRoomRate;angular.extend(self.roomRates,{tonightrateCodeWise:roomStatusResult.tonightrateCodeWise});self.loaded=true;var par=rt3Search.getParams();angular.extend(self,{otaRates:{brgFound:false}});$q.when(rt3api.getOTARates(par)).then(function(response){if(response.brgFound){if(Object.keys){var len=Object.keys(response.brg).length;var lastKey=Object.keys(response.brg)[len-1];if(len>4){delete response.brg[lastKey]}}}angular.extend(self,{otaRates:response})},function(response){angular.extend(self,{otaRates:{brgFound:false}})})})})};Browser.prototype.tonightRate=function(){var self=this;self.isRate=true;var code=[];rt3api.getAllRooms().then(function(response){$rootScope.$applyAsync(function(){angular.forEach(response.rooms,function(value,key){code.push(value.code)})})});rt3api.availableRoomsTonight().then(function(response){$rootScope.$applyAsync(function(){self.roomsTonight=response.room_details_list;self.tonightErrors=response.error_info.error_details;if(self.roomsTonight.length==0){self.isRate=false;self.roomRates=checkRoomStatus(response.room_details_list,self.roomsTonight.length,code)}else{this.isRate=true;self.toNightsRate="$"+Math.round(self.roomsTonight[0].min_average_price)+"<span>Tonight's Rate </span>  ";self.toNightsRate4BRG="$"+Math.round(self.roomsTonight[0].min_average_price);self.roomRates=checkRoomStatus(response.room_details_list,self.roomsTonight.length,code)}self.loaded=true})})};function checkRoomStatus(items,status,code,selectedRoomId){var tonightrate=[];var tonightrateCodeWise=[];var i,j;var totalmatches=0;var count=0;var myVals=code;var selectedRoomRate="CHECK AVAILABILITY";angular.forEach(myVals,function(value,key){tonightrateCodeWise[value]="CHECK AVAILABILITY"});if(status==0){for(i=0;i<myVals.length;i++){tonightrate[i]="CHECK AVAILABILITY"}return{tonightrate:tonightrate,tonightrateCodeWise:tonightrateCodeWise}}else{for(i=0;i<myVals.length;i++){for(j=0;j<items.length;j++){if(myVals[i]==items[j].code){count=0;tonightrate[i]="$ "+Math.round(items[j].min_average_price);tonightrateCodeWise[items[j].code]=tonightrate[i];if(selectedRoomId&&items[j].code.toLowerCase()==selectedRoomId.toLowerCase()){selectedRoomRate=tonightrate[i]}}else{count++;if(count==items.length||count==items.length-1){if(tonightrate.length==0||tonightrate.length==myVals.length-1){tonightrate[i]="CHECK AVAILABILITY";count=0}else{tonightrate[tonightrate.length]="CHECK AVAILABILITY";count=0}}}}}return{tonightrate:tonightrate,selectedRoomRate:selectedRoomRate,tonightrateCodeWise:tonightrateCodeWise}}}Browser.prototype.search=function(params){var date=new Date;var self=this;this.loaded=false;this.searchParams=params||rt3Search.getParams();this.thisDate=date.getFullYear()+"-"+("0"+(date.getMonth()+1)).slice(-2)+"-"+("0"+date.getDate()).slice(-2);if(this.searchParams||this.storageContainer){rt3api.availableRooms(this.searchParams||this.storageContainer).then(function(response){$rootScope.$apply(function(){self.rooms=response.room_details_list;if(self.rooms.length==0){self.getRate="Check Availability";$(".-count").css("font-size","23px");$(".-count").css("line-height","28px");$(".-count").css("text-align","center")}else{self.getRate="$ "+Math.round(self.rooms[0].min_average_price);$(".-count").css("font-size","43px");$(".-count").css("line-height","40px");$(".-count").css("text-align","left")}self.errors=response.error_info.error_details;self.loaded=true;self.searchParams=self.searchParams||self.storageContainer})})}else{rt3api.getAllRooms().then(function(response){$rootScope.$apply(function(){self.rooms=response.rooms;self.errors=response.error_info.error_details;self.loaded=true})})}};var browser=new Browser;var dataRoomId=window.location.search.substr(1);browser.tonightavailRooms(dataRoomId);browser.search();return browser}]).service("rt3SpecialRates",["$rootScope","$q","$location","rt3api","$filter",function($rootScope,$q,$location,rt3api,$filter){var specialRates={loaded:false,selectedOffer:window.location.hash.substr(1).replace("%2F",""),sRdetail:{}};specialRates.ready=$q(function(resolve){rt3api.getAllSpecialRates().then(function(response){$rootScope.$applyAsync(function(){var formatResponseValue,hashName,tmpName;formatResponseValue=formatRespone(response);if(specialRates.selectedOffer){angular.forEach(response.special_rates,function(value,key){tmpName=$filter("formatNameForLink")(value.rate_plan_name);hashName=$filter("formatNameForLink")(specialRates.selectedOffer);if(tmpName==hashName||value.rate_plan_code==specialRates.selectedOffer){angular.extend(specialRates.sRdetail,value)}})}angular.extend(specialRates,formatResponseValue);specialRates.loaded=true;resolve(specialRates)})})});return specialRates;function formatRespone(response){var formattedResponse=response;var validDayOfWeek={valid_day_of_week_text:""};angular.forEach(response.special_rates,function(value,key){if(value.valid_days_of_week.replace(/,/g,"")=="1234567")validDayOfWeek.valid_day_of_week_text="All days of the week";else if(value.valid_days_of_week!="")validDayOfWeek.valid_day_of_week_text=value.valid_days_of_week+" days of the week";angular.extend(formattedResponse.special_rates[key],validDayOfWeek)});return formattedResponse}}]).service("rt3RoomDetails",["$rootScope","$q","$location","rt3Search","rt3api","$timeout","$filter",function($rootScope,$q,$location,rt3Search,rt3api,$timeout,$filter){function RoomDetails(){loaded=false;params={};brg={};locationHash=$location.path().substr(1)}RoomDetails.prototype.fetchRoomDetails=function(){var self=this;var searchParams=rt3Search.getParams();var roomName=window.location.hash.substr(1).replace("%2F","");$q.when(rt3api.getAllAvailableRooms(searchParams)).then(function(response){var roomCategories=response.rooms.map(function(obj){return obj.category});roomCategories=roomCategories.filter(function(v,i){return roomCategories.indexOf(v)==i});self.roomCategories=roomCategories;$.each(response.rooms,function(key,value){if($filter("formatNameForLink")(value.name)==$filter("formatNameForLink")(roomName)||value.code==roomName){angular.extend(self,value);roomRate=value.min_discounted_average_price[0]||value.min_average_price[0];if(roomRate==null){todayRate={todayRate:"CHECK AVAILABILITY"}}else{todayRate={todayRate:"$"+Math.round(roomRate)}}angular.extend(self,todayRate)}})});$q.when(rt3api.getBrgInfo(self.params)).then(function(response){self.brg=response})};var details=new RoomDetails;$rootScope.$on("$locationChangeSuccess",function(){details.fetchRoomDetails()});$timeout(function(){details.fetchRoomDetails()},0);return details}]).service("rt3RecentBookings",["$rootScope","$q","rt3api",function($rootScope,$q,rt3api){var recentBookings={loaded:false};recentBookings.ready=$q(function(resolve){rt3api.recentBookings(48*60).then(function(response){$rootScope.$apply(function(){angular.extend(recentBookings,response);recentBookings.loaded=true;recentBookings=response;resolve(recentBookings)})})});return recentBookings}]).service("rt3RateShopping",["$q","rt3api","rt3Search",function($q,rt3api,rt3Search){function RateShopping(){rt3Search;this.loaded=false;this.params=rt3Search.getParams();getRateShopping(this)}function getRateShopping(self){$q.when(rt3api.getRateShopping(self.params)).then(function(response){angular.extend(self,response);this.loaded=true})}return new RateShopping}]);angular.module("rezTrip").directive("rt3HotelInfo",["rt3HotelInfo",function(rt3HotelInfo){return{restrict:"A",scope:true,link:function(scope,element,attrs){scope[attrs["rt3HotelInfo"]]=rt3HotelInfo}}}]).directive("rt3SearchForm",["rt3Search",function(rt3Search){return{restrict:"A",scope:true,link:function(scope,element,attrs){scope[attrs["rt3SearchForm"]]=rt3Search}}}]).directive("rt3RoomsBrowser",["rt3Browser","$rootScope",function(rt3Browser,$rootScope){return{restrict:"A",scope:true,link:function(scope,element,attrs){scope[attrs["rt3RoomsBrowser"]]=rt3Browser}}}]).directive("rt3SpecialRates",["rt3SpecialRates",function(rt3SpecialRates){return{restrict:"A",scope:true,link:function(scope,element,attrs){scope[attrs["rt3SpecialRates"]]=rt3SpecialRates}}}]).directive("rt3RoomDetails",["rt3RoomDetails",function(rt3RoomDetails){return{restrict:"A",scope:true,link:function(scope,element,attrs){scope[attrs["rt3RoomDetails"]]=rt3RoomDetails}}}]).directive("rt3RecentBookings",["rt3RecentBookings",function(rt3RecentBookings){return{restrict:"A",scope:true,link:function(scope,element,attrs){scope[attrs["rt3RecentBookings"]]=rt3RecentBookings}}}]).directive("rt3RateShopping",["rt3RateShopping",function(rt3RateShopping){return{restrict:"A",scope:true,link:function(scope,element,attrs){scope[attrs["rt3RateShopping"]]=rt3RateShopping}}}]).directive("rt3RateCalendar",["rt3RateCalendar",function(rt3RateCalendar){return{restrict:"A",scope:true,link:function(scope,element,attrs){setTimeout(function(){var dayrates;var dateFormat="yy-mm-dd";var options=$(element).data("options");var isBaseRoom=options.baseroom;var checkinEle=options.checkinEle;var checkoutEle=options.checkoutEle;var apiFunc=isBaseRoom?rt3RateCalendar:"";var availability=true;$.when(apiFunc).then(function(response){if(response){dayrates=[{}];$.each(response.rate_calendar_dates,function(index,value){dayrates[0][value.date]=value.best_available_rate?"$"+Math.round(value.best_available_rate):"NA"});if(!response.rate_calendar_dates){availability=false}}$(element).datepicker("option","beforeShowDay",function(date){var selectable=true;var classname="";var date1=$.datepicker.parseDate(dateFormat,$("#"+checkinEle).val());var date2=$.datepicker.parseDate(dateFormat,$("#"+checkoutEle).val());var title="";if(dayrates){title=dayrates[0][date.getFullYear()+"-"+(date.getMonth()+1<10?"0"+(date.getMonth()+1):date.getMonth()+1)+"-"+(date.getDate()<10?"0"+date.getDate():date.getDate())]}if(title){return[true,date1&&(date.getTime()==date1.getTime()||date2&&date>=date1&&date<=date2)?"dp-highlight":"",title]}else{return[true,date1&&(date.getTime()==date1.getTime()||date2&&date>=date1&&date<=date2)?"dp-highlight":""]}});$(element).datepicker("option","onSelect",function(dateText,inst){var date1=$.datepicker.parseDate(dateFormat,$("#"+checkinEle).val());var date2=$.datepicker.parseDate(dateFormat,$("#"+checkoutEle).val());var selectedDate=$.datepicker.parseDate(dateFormat,dateText);if(!date1||date2){$("#"+checkinEle).val(dateText);$("#"+checkoutEle).val("")}else if(selectedDate<date1){$("#"+checkinEle).val($("#"+checkinEle).val());$("#"+checkoutEle).val(dateText)}else{$("#"+checkoutEle).val(dateText)}$(this).datepicker()});if(isBaseRoom&&availability){$(" .ui-datepicker").after('<div class="middle" style="padding:5px;margin-top:-3rem;margin-bottom:3rem;background-color:#000;color:#fff;font-size:13px;>Standard rates shown. Choose your stay dates to check actual pricing and availability.</div>')}})},3300)}}}]);angular.module("rezTrip").filter("isArray",[function(){return function(input){return angular.isArray(input)}}]).filter("formatpolicydescription",function(){return function(text){return text?String(text).replace('["',"<p>").replace('"]',"</p>").replace(","," "):""}}).filter("ampersand",function(){return function(input){return input?input.replace(/&amp;/,"&"):""}}).filter("renderHTMLCorrectly",function($sce){return function(stringToParse){return $sce.trustAsHtml(stringToParse)}}).filter("replaceNewline",function(){return function(value){return!value?"":String(value).replace(/\n+/g,"<br>")}}).filter("formatNameForLink",function(){return function(value){var retString=String(value).toLowerCase();retString=retString.replace(/^\s\s*/,"").replace(/\s\s*$/,"");retString=retString.replace("%","percent");retString=retString.replace(/[^A-Z0-9]+/gi,"-");retString=retString.replace(/^--s*/,"").replace(/--*$/,"");return!value?"":retString}}).filter("range",function(){return function(input,total){total=parseInt(total);for(var i=0;i<total;i++){input.push(i)}return input}}).filter("roomOrSuite",function(){return function(value){var str=String(value).toLowerCase();var retStr;if(str.indexOf("suite")!=-1){retStr="Suite"}else{retStr="Room"}return!value?"":retStr}});$(function(){$.event.special.inputchange={setup:function(){var self=this,val;$.data(this,"timer",window.setInterval(function(){val=self.value;if($.data(self,"cache")!=val){$.data(self,"cache",val);$(self).trigger("inputchange")}},30))},teardown:function(){window.clearInterval($.data(this,"timer"))},add:function(){$.data(this,"cache",this.value)}};var rt3Model_api="/assets/js/rt3/models/rt3models-data.json";if($("input#roomCode")&&$("[rt3-room-details]").length>0){$("input#roomCode").on("inputchange",function(){var roomcode=this.value;var detail_container=$("[rt3-room-details]").find("[room-detail]");var amenities_container=$("[rt3-room-details]").find("[room-amenities]");var room_carousel_image=$("[rt3-room-details]").find("[room-gallery]");var room_additional=$("[rt3-room-details]").find("[addition-detail]");var room_carousel_indicator=$("[rt3-room-details]").find("[rt3-roomcarousel-indicator]");var totPhotos=$("#totPhotos")?$("#totPhotos").val():0;$.getJSON(rt3Model_api,function(data){if(data.roomsDetails[roomcode].gallery!=null){$.each(data.roomsDetails[roomcode].gallery,function(i,item){var newindicatortotl=totPhotos++;if(item.url_large&&item.url_large!=""){room_carousel_image.append('<div class="carousel-item" style="background-image: url('+item.url_large+');"></div>');room_carousel_indicator.append('<li data-target="#room-details-carousel" data-slide-to="'+newindicatortotl+'"></li>')}})}if(data.roomsDetails[roomcode].title){document.title=data.roomsDetails[roomcode].title;console.log(data.roomsDetails[roomcode].title)}room_additional.html(data.roomsDetails[roomcode].additionalInfo);if(data.roomsDetails[roomcode]!=undefined&&data.roomsDetails[roomcode].room_features&&data.roomsDetails[roomcode].replaceReztrip==true){if($.trim(data.roomsDetails[roomcode].room_features)!=""){detail_container.html(data.roomsDetails[roomcode].room_features)}detail_container.show()}else if(data.roomsDetails[roomcode]!=undefined&&data.roomsDetails[roomcode].room_features&&data.roomsDetails[roomcode].replaceReztrip==false){if($.trim(data.roomsDetails[roomcode].room_features)!=""){detail_container.append(data.roomsDetails[roomcode].room_features)}detail_container.show()}else{detail_container.show()}if(data.roomsDetails[roomcode]!=undefined&&data.roomsDetails[roomcode].service_amenities&&data.roomsDetails[roomcode].replaceAmenities==true){if($.trim(data.roomsDetails[roomcode].service_amenities)!=""){amenities_container.html(data.roomsDetails[roomcode].service_amenities)}amenities_container.show()}else if(data.roomsDetails[roomcode]!=undefined&&data.roomsDetails[roomcode].service_amenities&&data.roomsDetails[roomcode].replaceAmenities==false){if($.trim(data.roomsDetails[roomcode].service_amenities)!=""){amenities_container.append(data.roomsDetails[roomcode].service_amenities)}amenities_container.show()}else{amenities_container.show()}if(data.roomsDetails[roomcode].floor_plan_pdf!=null){$.each(data.roomsDetails[roomcode].floor_plan_pdf,function(i,pdf){if(pdf.url&&pdf.url!=""){var activeClassname="carousel-item active";$("#floorplans-pdf").find(".carousel-control-prev, .carousel-control-next").hide();if(i>0){activeClassname="carousel-item";$("#floorplans-pdf").find(".carousel-control-prev, .carousel-control-next").show()}var pdfcarousel='<div class="'+activeClassname+'"> <object data="'+pdf.url+'" type="application/pdf" width="100%" height="100%"><p class="pdf-no-support">This browser does not support PDFs. Please download the PDF to view it:.</p> <a href="'+pdf.url+'" class="floor-plan-btn" target="_blank"><i class="map-icon"></i>View Floor Plan  </a> </object> <a href="'+pdf.url+'" target="_blank" class="enlarge-btn">View Larger Version</a></div>';if($("#floorplans-pdf")){$("#floorplans-pdf").find(".carousel-inner").append(pdfcarousel)}}})}})})}if($("input#listing")){$("input#listing").on("inputchange",function(ev){var pagelisting=this.value;if(pagelisting=="true"){$.getJSON(rt3Model_api,function(data){$("[data-rt3room]").each(function(){var rt3roomid=$(this).data("rt3room");if($(this).data("rt3room")!=""){if(data.roomsDetails[rt3roomid]!=undefined&&data.roomsDetails[rt3roomid].short_info&&data.roomsDetails[rt3roomid].short_info!=""){$(this).find("[data-rt3room-info]").html(data.roomsDetails[rt3roomid].short_info)}}})})}})}if($("input#offerslisting")){$("input#offerslisting").on("inputchange",function(ev){var offerlisting=this.value;if(offerlisting=="true"){$.getJSON(rt3Model_api,function(data){$("[data-rt3offer]").each(function(){var rt3offerid=$(this).data("rt3offer");if($(this).data("rt3offer")!=""){if(data.offersDetails[rt3offerid]!=undefined&&data.offersDetails[rt3offerid].additionalInfo&&data.offersDetails[rt3offerid].replaceReztrip==true){if($.trim(data.offersDetails[rt3offerid].additionalInfo)!=""){$(this).find("[data-rt3offer-info]").html(data.offersDetails[rt3offerid].additionalInfo)}}else if(data.offersDetails[rt3offerid]!=undefined&&data.offersDetails[rt3offerid].additionalInfo&&data.offersDetails[rt3offerid].replaceReztrip==false){if($.trim(data.offersDetails[rt3offerid].additionalInfo)!=""){$(this).find("[data-rt3offer-info]").append(data.offersDetails[rt3offerid].additionalInfo)}}else{}}})})}})}});$("body").prepend('<div id="preloader"><div class="spinner-sm spinner-sm-1" id="status"> </div></div>');$(window).on("load",function(){$("#status").fadeOut();$("#preloader").delay(350).fadeOut("slow");$("body").delay(350).css({overflow:"visible"})});navOnScroll();$(".selectpicker").selectpicker({style:"btn-transparent",size:4});$("#arrival_date").datepicker({dateFormat:"yy-mm-dd",altField:"#arrival_date",altFormat:"yy-mm-dd",minDate:0,onSelect:function(date){var date2=$("#arrival_date").datepicker("getDate");date2.setDate(date2.getDate()+1);$("#departure_date").datepicker("setDate",date2);$("#departure_date").datepicker("option","minDate",date2)}});$("#departure_date").datepicker({dateFormat:"yy-mm-dd",altField:"#departure_dates",altFormat:"yy-mm-dd",onClose:function(){var dt1=$("#v").datepicker("getDate");console.log(dt1);var dt2=$("#departure_date").datepicker("getDate");if(dt2<=dt1){var minDate=$("#departure_date").datepicker("option","minDate");$("#departure_date").datepicker("setDate",minDate)}}});$(".filter").on("click",function(){var $this=$(this);if(!$this.hasClass("active")){$(".filter").removeClass("active");$this.addClass("active");var $filter=$this.data("rel");$filter=="all"?$(".fancybox").attr("data-fancybox-group","gallery").not(":visible").fadeIn():$(".fancybox").fadeOut(0).filter(function(){return $(this).data("filter")==$filter}).attr("data-fancybox-group",$filter).fadeIn(1e3)}});$(window).on("load",function(){$("ul.navbar-nav li.dropdown a").attr("data-toggle","disable");if($(window).width()>1200){jQuery("ul.navbar-nav li.dropdown").hover(function(){jQuery(this).find(".dropdown-menu").stop(true,true).delay(200).fadeIn()},function(){jQuery(this).find(".dropdown-menu").stop(true,true).delay(200).fadeOut()})}else{$("ul.navbar-nav li.dropdown").click(function(e){e.preventDefault();jQuery(this).find(".dropdown-menu").fadeToggle();$(this).find(".nav-link").toggleClass("open")});$("ul.navbar-nav li.dropdown a span").click(function(){var link=jQuery(this).closest("a").attr("href");window.location.href=link});$("ul.navbar-nav li.dropdown .dropdown-item").click(function(){var link=jQuery(this).closest("a").attr("href");window.location.href=link})}$(".categories__list li").hover(function(){$(this).find(".list-dropdown").slideDown(100)},function(){$(this).find(".list-dropdown").slideUp(100)})});$(window).on("load",function(e){var ownerId="6142505566";var instaurl="https://apinsta.herokuapp.com/u/thepierreny/";var instaFeedUrl="https://www.instagram.com/p/";$.ajax({url:instaurl,dataType:"json",success:function(response){console.log("ok insta",response);var showInstaFeeds=[],feedCount=0;var allFeeds=response.graphql.user.edge_owner_to_timeline_media.edges;showInstaFeeds=$.grep(allFeeds,function(ele,i){return ele.node.owner.id==ownerId});if(showInstaFeeds.length<6){for(var j=0;j<allFeeds.length;j++){if(allFeeds[j].node.owner.id!=ownerId){showInstaFeeds.push(allFeeds[j]);feedCount++;if(feedCount>7)break}}}setTimeout(function(){$.each(showInstaFeeds,function(i,item){if($(window).width()>=767){if(i>3)return false}else{if(i>3)return false}$('<div class="feed bg-cover" style="background-image:url('+item.node.thumbnail_src+');"><a href="'+instaFeedUrl+item.node.shortcode+'" target="_blank"><p class="insta-icons"> <br><i class="far fa-heart" aria-hidden="true"></i>'+item.node.edge_liked_by.count+' <i class="far fa-comment" aria-hidden="true"></i>'+item.node.edge_media_to_comment.count+"</p></a></div>").appendTo(".instagram-feed")});var heightDIV=$(".instagram-feed div:first-child").innerWidth();$(".instagram-feed div").each(function(){$(this).css("height",heightDIV+"px")});$(".instagram-feed").slideDown("slow")},500)}})});setTimeout(function(){$("#commonCarousel, #rotundaCarousel").slick({dots:false,infinite:true,speed:300,slidesToShow:4,slidesToScroll:1,centerMode:false,adaptiveHeight:true,centerPadding:"15px",responsive:[{breakpoint:990,settings:{slidesToShow:2,centerPadding:"15px"}},{breakpoint:500,settings:{slidesToShow:1,centerPadding:"15px"}}]});$(".loading").css("display","none")},2500);$(".history-nav a").click(function(){$(".history-nav a").removeClass("active");$(this).addClass("active")});$(".pierre-slider").slick({autoplay:true,dots:false,centerMode:true,centerPadding:"16%",slidesToShow:1,accessibility:false,responsive:[{breakpoint:768,settings:{arrows:false,centerMode:true,centerPadding:"4px",slidesToShow:1}},{breakpoint:480,settings:{arrows:false,centerMode:true,centerPadding:"4px",slidesToShow:1}}]});function pinterestShare(img,desc){window.open("//www.pinterest.com/pin/create/button/"+"?url="+window.location.href+"&media="+img+"&description="+desc,"pinIt","toolbar=no, scrollbars=no, resizable=no, top=0, right=0");return false}$(".gallery-wrapper .sub-nav li a").on("click",function(){$(".gallery-wrapper .sub-nav li a").each(function(){$(this).removeClass("active")});$(this).addClass("active");var $filter=$(this).attr("data-filter");if($filter=="all"){$(".fancybox").attr("data-fancybox-group","gallery").not(":visible").fadeIn()}else{$(".fancybox").fadeOut(0).filter(function(){return $(this).data("filter")==$filter}).attr("data-fancybox-group",$filter).fadeIn(1e3);setTimeout(function(){var lightgallery=$("[data-offergallery]");if(lightgallery.length>0){lightgallery.data("lightGallery").destroy(true);$("[data-offergallery]").lightGallery({selector:".item:visible",counter:false,share:false})}},1e3)}});$("[data-offergallery]").lightGallery({selector:".item",counter:false,download:false,fullScreen:false});$(document).on("focus",".navbar-nav .nav-item > a",function(){$(".dropdown-menu").hide();var parentListItem=$(this).closest("li");if(parentListItem.hasClass("dropdown")){$(this).closest(".dropdown").find(".dropdown-menu").show()}});var iframeFound=setInterval(function(){console.log("not found");if($("#gtsgig").length>0){$("#gtsgig").attr("title","gts gig");clearInterval(iframeFound);console.log("found")}},60);